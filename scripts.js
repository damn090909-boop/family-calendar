...
// --- API Configuration ---
const API_BASE_URL = 'https://script.google.com/macros/s/AKfycbx2CZijLs7zcgRJZyMtDB0eBYEgF0RQH9DY1hO7c-vWp03b-rbokJp2e33eOboT9f-7/exec';
...
function renderDayEvents() {
    ...
    if (events.length === 0) {
        ...
        events.forEach((evt, index) => {
            ...
            const imgHtml = user.photo ? `<img src="${user.photo}" class="event-user-img" style="width:30px;height:30px;border-radius:50%;margin-right:8px;vertical-align:middle;">` : '';
